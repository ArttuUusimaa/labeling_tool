...
export default class SseToolbar3d extends SseToolbar {
    ...
    componentDidMount() {
        ...
        this.addCommand("downloadTextLabelCommand", "PCD Output Labels as Text", false, "", "downloadTextLabel", FileDownloadOutline);
        this.addCommand("downloadFileLabelCommand", "PCD Output Labels as File", false, "", "downloadFileLabel", FileDownloadOutline);
        this.addCommand("downloadTextObjectCommand", "PCD Output Object as Text", false, "", "downloadTextObject", FileDownloadOutline);
        this.addCommand("downloadFileObjectCommand", "PCD Output Object as File", false, "", "downloadFileObject", FileDownloadOutline);
            ...
            <div className="hflex flex-justify-content-space-around sse-toolbar toolbar-3d no-shrink">
                ...
                <div className="vflex">
                    ...
                    <div className="hflex">
                        ...
                        {this.renderCommand("downloadTextLabelCommand")}
                        {this.renderCommand("downloadFileLabelCommand")}
                        {this.renderCommand("downloadTextObjectCommand")}
                        {this.renderCommand("downloadFileObjectCommand")}
                    </div>
                </div>
            </div>
        )
