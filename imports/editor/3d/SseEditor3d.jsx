...
export default class SseEditor3d extends React.Component {
    ...
    componentDidMount() {
        ...
        this.onMsg("downloadFileLabel", () => this.downloadFileLabel());
        this.onMsg("downloadTextLabel", () => this.downloadTextLabel());
        this.onMsg("downloadFileObject", () => this.downloadFileObject());
        this.onMsg("downloadTextObject", () => this.downloadTextObject());
    ...
    downloadFileLabel() {
        window.open("/api/pcdfilelabel" + this.props.imageUrl, "_blank");
    }

    downloadTextLabel() {
        window.open("/api/pcdtextlabel" + this.props.imageUrl, "_blank");
    }

    downloadFileObject() {
        window.open("/api/pcdfileobject" + this.props.imageUrl, "_blank");
    }

    downloadTextObject() {
        window.open("/api/pcdtextobject" + this.props.imageUrl, "_blank");
    }
